...
/****** Object:  Database [MovieTheaterShowings]    Script Date: 6/23/2017 8:59:21 AM ******/
CREATE DATABASE [MovieTheaterShowings]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MovieTheaterShowings', FILENAME = N'C:\Users\jeremy.brammer\Documents\Visual Studio 2013\Projects\MovieTheaterShowings\database_related\file_databases\MovieTheaterShowings.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'MovieTheaterShowings_log', FILENAME = N'C:\Users\jeremy.brammer\Documents\Visual Studio 2013\Projects\MovieTheaterShowings\database_related\file_databases\MovieTheaterShowings_log.ldf' , SIZE = 1280KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
BEGIN
	...
	DBCC CHECKIDENT ('MovieTheaterShowings.dbo.LinkerUserToRoles',RESEED, 0)
